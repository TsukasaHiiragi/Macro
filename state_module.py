...
def receive():
    a = Assister('receive')
    a.dmy('head').connect(a.man('mypage'))
    a.man('mypage').connect(a.brn('mypage'))
    a.brn('mypage').connect(a.man('mission'))
    a.man('mission').connect(a.brn('mission'))
    a.brn('mission').connect(a.man('daily'))
    a.man('daily').connect(a.brn('daily'))
    a.brn('daily').connect(a.man('ok1'))
    a.man('ok1').connect(a.brn('ok1'))
    a.brn('ok1').connect(a.man('present'))
    a.man('present').connect(a.brn('present'))
    a.brn('present').connect(a.man('receive'))
    a.man('receive').connect(a.brn('receive'))
    a.brn('receive').connect(a.man('tab'))
    a.man('tab').connect(a.brn('tab'))
    a.brn('tab').connect(a.man('ok2'))
    a.man('ok2').connect(a.brn('ok2'))
    a.brn('ok2').connect(a.man('ok3'))
    a.man('ok3').connect(a.brn('ok3'))
    a.brn('ok3').connect(a.dmy('tail'))    
